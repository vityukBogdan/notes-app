...
return function (App $app) {
    ...
    $app->options('/notes/add', function (Request $request, Response $response): Response {
        return $response;
    });

    $app->put('/notes/update/{id:[0-9]+}', \App\Action\NotesUpdateAction::class);
    $app->options('/notes/update/{id:[0-9]+}', function (Request $request, Response $response): Response {
        return $response;
    });
